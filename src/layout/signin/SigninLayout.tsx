...
const InputBundle = styled.div`
  position: relative;
  width: calc(100vw * 26.3 / 100);
  height: calc(100vh * 5.2 / 100);
  top: calc(100vh * 10.3 / 100);
  margin: auto;
`
const Input = styled.input`
  position: absolute;
  width: calc(100vw * 25.8 / 100);
  height: calc(100vh * 5.2 / 100);
  ...
  text-indent: calc(100vh * 6 / 100);
`
const Icon = styled.div`
  position: absolute;
  bottom: calc(100vh * 1 / 100);
  padding-left: 1.2vw;
`
const Button = styled.div`
  position: relative;
  top: calc(100vh * 12.3 / 100);
